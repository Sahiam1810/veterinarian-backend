...
public sealed record GetAllRacesQuery(Guid? SpeciesId = null) : IRequest<IReadOnlyCollection<RaceEntity>>;
...
public sealed class GetAllRacesQueryHandler : IRequestHandler<GetAllRacesQuery, IReadOnlyCollection<RaceEntity>>
{
    ...
    {
        return await _uow.RacesRepository.GetAllAsync(request.SpeciesId, cancellationToken);
    }
}
