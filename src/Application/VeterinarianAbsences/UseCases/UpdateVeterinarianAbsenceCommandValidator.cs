...
public sealed class UpdateVeterinarianAbsenceCommandValidator
    : AbstractValidator<UpdateVeterinarianAbsenceCommand>
{
    public UpdateVeterinarianAbsenceCommandValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("El id de la ausencia es requerido.");
