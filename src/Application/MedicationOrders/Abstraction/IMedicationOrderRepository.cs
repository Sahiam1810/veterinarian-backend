...
public interface IMedicationOrderRepository
{
    ...
    Task<IEnumerable<MedicationOrder>> GetByHospitalizationStayAsync(Guid hospitalizationStayId, Guid? appointmentId, CancellationToken cancellationToken = default);
