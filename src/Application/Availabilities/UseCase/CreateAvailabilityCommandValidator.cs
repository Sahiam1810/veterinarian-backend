...
{
    public CreateAvailabilityCommandValidator(IUnitOfWork unitOfWork)
    {
        ...
        RuleFor(x => x)
            .MustAsync(async (command, cancellationToken) =>
                !await unitOfWork.AvailabilitiesRepository.ExistsOverlapAsync(
                    ...
                    command.EndTime,
                    cancellationToken))
            .WithMessage("Ya existe una disponibilidad que se cruza con ese horario para este veterinario.");
    }
}
