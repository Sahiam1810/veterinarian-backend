...
public sealed class CreateAiModelCommandValidator : AbstractValidator<CreateAiModelCommand>
{
    ...
    {
        RuleFor(command => command.ProviderModelAiId)
            .NotEmpty()
            .WithMessage("El proveedor de IA es obligatorio.");
