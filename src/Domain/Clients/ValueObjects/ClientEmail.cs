...
public sealed record ClientEmail
{
    ...
    private ClientEmail(string value) => Value = value;
    ...
    public static ClientEmail Create(string value)
    {
        ...
        {
            throw new ArgumentException($"El correo electrónico no puede superar los {MaxLength} caracteres.", nameof(value));
        }
