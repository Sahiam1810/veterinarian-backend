...
USING (
    ...
    SELECT 'bbbb0050-0000-0000-0000-000000000007' AS CREDENTIAL_ID, 'bbbb0040-0000-0000-0000-000000000007' AS ACCOUNT_ID, '$2a$11$eN7xN61c6iX2y7r2Gk4rAeK2o7k4f4W8l3x1Z9c0B2m5n8v7a1s3.' AS PASSWORD_HASH FROM DUAL UNION ALL
    SELECT 'bbbb0050-0000-0000-0000-000000000008' AS CREDENTIAL_ID, 'bbbb0040-0000-0000-0000-000000000008' AS ACCOUNT_ID, '$2a$11$eN7xN61c6iX2y7r2Gk4rAeK2o7k4f4W8l3x1Z9c0B2m5n8v7a1s3.' AS PASSWORD_HASH FROM DUAL UNION ALL
    SELECT 'bbbb0050-0000-0000-0000-000000000009' AS CREDENTIAL_ID, 'bbbb0040-0000-0000-0000-000000000009' AS ACCOUNT_ID, '$2a$11$eN7xN61c6iX2y7r2Gk4rAeK2o7k4f4W8l3x1Z9c0B2m5n8v7a1s3.' AS PASSWORD_HASH FROM DUAL UNION ALL
    SELECT 'bbbb0050-0000-0000-0000-000000000010' AS CREDENTIAL_ID, 'bbbb0040-0000-0000-0000-000000000010' AS ACCOUNT_ID, '$2a$11$eN7xN61c6iX2y7r2Gk4rAeK2o7k4f4W8l3x1Z9c0B2m5n8v7a1s3.' AS PASSWORD_HASH FROM DUAL
) source
...
USING (
    ...
    SELECT 'bbbb0006-0000-0000-0000-000000000003' AS ID, 'bbbb0004-0000-0000-0000-000000000007' AS USER_ID, '1011121314' AS IDENTIFICATION_NUMBER, 'Avenida Siempreviva 742' AS ADDRESS, '3001112233' AS PHONE_NUMBER, TO_DATE('2026-03-05', 'YYYY-MM-DD') AS REGISTRATION_DATE FROM DUAL UNION ALL
    ...
    SELECT 'bbbb0006-0000-0000-0000-000000000005' AS ID, 'bbbb0004-0000-0000-0000-000000000009' AS USER_ID, '1088899900' AS IDENTIFICATION_NUMBER, 'Boulevard de los Sueños Rotos' AS ADDRESS, '3228889900' AS PHONE_NUMBER, TO_DATE('2026-05-12', 'YYYY-MM-DD') AS REGISTRATION_DATE FROM DUAL UNION ALL
