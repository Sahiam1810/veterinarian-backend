...
BEGIN
    ...
    ensure_permission('3b9dde6d-68e1-4470-b82c-327feb02f4f6', '11111111-1111-1111-1111-111111111111', 'Historiales Cl├¡nicos', 1, 1, 1, 1);
    ...
    ensure_permission('1ab5c377-ad36-48db-bd3b-db02eecf2d64', '44444444-4444-4444-4444-444444444444', 'Historiales Cl├¡nicos', 1, 1, 1, 0);
    ...
    ensure_permission('2f85e7b7-1b66-4c71-8195-75dd77a5cf7c', '55555555-5555-5555-5555-555555555555', 'Historiales Cl├¡nicos', 1, 0, 0, 0);
    ...
    ensure_permission('8fee0f45-2c62-4aef-aae8-63a59df078a6', '66666666-6666-6666-6666-666666666666', 'Historiales Cl├¡nicos', 1, 0, 0, 0);
    ...
    -- Cliente = chatbot / Telegram / OTP autoservicio; NO plataforma web (ADR Opci├│n A).
    -- ensure_permission solo inserta: sin DELETE, DBs ya sembradas conservar├¡an canView de men├║.
