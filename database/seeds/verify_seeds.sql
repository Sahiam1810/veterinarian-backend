...
PROMPT
PROMPT =========================================================================
PROMPT 3. DETALLE DE USUARIOS Y ACCESO AL SISTEMA
PROMPT =========================================================================

-- U5: USER_ACCOUNTS/USER_CREDENTIALS se fusionaron en USERS.
SELECT
    u.EMAIL,
    r.NAME AS ROL,
    u.FULL_NAME,
    CASE WHEN u.IS_ACTIVE = 1 THEN 'ACTIVO' ELSE 'INACTIVO' END AS ESTADO,
    CASE WHEN u.PASSWORD_HASH IS NOT NULL AND u.PASSWORD_HASH != '' THEN 'SI' ELSE 'NO' END AS TIENE_PASSWORD
FROM USERS u
