...
// SEC-04: manipular tokens de sesión de cualquier usuario (crearlos a mano,
// verlos, borrarlos) quedó exclusivo de SuperAdmin. Antes era
// RequirePermission("Usuarios", ...), que dejaba a Administrador (sin ser
// SuperAdmin) manipular tokens.
public sealed class UserTokensAuthorizationTests
{
    ...
    [InlineData(nameof(UserTokensController.GetByUserId))]
