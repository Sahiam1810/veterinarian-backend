...
{
    [Fact]
    public void Client_mapping_has_unique_phone_number_index_with_clr_nullable_for_read_tolerance()
    {
        ...
        // CLR/converter nullable: histórico inválido → null en memoria. Oracle sigue NOT NULL (sin migration).
